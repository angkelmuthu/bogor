        ...
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                ...
                <div class="panel-container show">
                    ...
                    <div class="row">
                    <div class="col-md-6">
        <?php echo anchor(site_url('t_rincian_smt/create'), '<i class="fal fa-plus-square" aria-hidden="true"></i> Tambah Data', 'class="btn btn-primary btn-sm waves-effect waves-themed"'); ?></div>
<div class="col-md-6">
