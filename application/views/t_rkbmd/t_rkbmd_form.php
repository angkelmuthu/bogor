						...
						<form action="<?php echo $action; ?>" method="post">
							...
							<table class='table table-striped'>
								...
								<tr>
									...
									<td><input type="number" class="form-control" name="semula_jumlah" id="semula_jumlah" placeholder="Semula Jumlah" value="<?php echo $semula_jumlah; ?>" required /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="number" class="form-control" name="menjadi_jumlah" id="menjadi_jumlah" placeholder="Menjadi Jumlah" value="<?php echo $menjadi_jumlah; ?>" required /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="number" class="form-control" name="km_jumlah" id="km_jumlah" placeholder="Km Jumlah" value="<?php echo $km_jumlah; ?>" required /></td>
								</tr>
								<tr>
									<td width='200'>Km Satuan <?php echo form_error('km_satuan') ?></td>
									<td><input type="text" class="form-control" name="km_satuan" id="km_satuan" placeholder="Km Satuan" value="<?php echo $km_satuan; ?>" required /></td>
								</tr>
								<tr>
									<td width='200'>Optim Kode Barang <?php echo form_error('optim_kode_barang') ?></td>
									<td><input type="text" class="form-control" name="optim_kode_barang" id="optim_kode_barang" placeholder="Optim Kode Barang" value="<?php echo $optim_kode_barang; ?>" required /></td>
								</tr>
								<tr>
									<td width='200'>Optim Nama Barang <?php echo form_error('optim_nama_barang') ?></td>
									<td><input type="text" class="form-control" name="optim_nama_barang" id="optim_nama_barang" placeholder="Optim Nama Barang" value="<?php echo $optim_nama_barang; ?>" required /></td>
								</tr>
								<tr>
									<td width='200'>Optim Jumlah <?php echo form_error('optim_jumlah') ?></td>
									<td><input type="number" class="form-control" name="optim_jumlah" id="optim_jumlah" placeholder="Optim Jumlah" value="<?php echo $optim_jumlah; ?>" required /></td>
								</tr>
								<tr>
									<td width='200'>Optim Satuan <?php echo form_error('optim_satuan') ?></td>
									<td><input type="text" class="form-control" name="optim_satuan" id="optim_satuan" placeholder="Optim Satuan" value="<?php echo $optim_satuan; ?>" required /></td>
								</tr>
								<tr>
									<td width='200'>Riil Jumlah <?php echo form_error('riil_jumlah') ?></td>
									<td><input type="text" class="form-control" name="riil_jumlah" id="riil_jumlah" placeholder="Riil Jumlah" value="<?php echo $riil_jumlah; ?>" required /></td>
								</tr>
								<tr>
									<td width='200'>Riil Satuan <?php echo form_error('riil_satuan') ?></td>
									<td><input type="text" class="form-control" name="riil_satuan" id="riil_satuan" placeholder="Riil Satuan" value="<?php echo $riil_satuan; ?>" required /></td>
								</tr>
								<tr>
									<td></td>
