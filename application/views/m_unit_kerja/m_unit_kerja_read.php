...
<div class="row">
    <div class="col-xl-12">
	    ...
	    <tr><td>Kode Jenis Unit</td><td><?php echo $kode_jenis_unit; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('m_unit_kerja') ?>" class="btn btn-primary waves-effect waves-themed">Kembali</a></td></tr>
	</table>
</div>
</div>
