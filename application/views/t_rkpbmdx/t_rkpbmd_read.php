...
<div class="row">
    <div class="col-xl-12">
	    ...
	    <tr><td>Kondisi Barang B</td><td><?php echo $kondisi_barang_b; ?></td></tr>
	    <tr><td>Kondisi Barang Rr</td><td><?php echo $kondisi_barang_rr; ?></td></tr>
	    <tr><td>Kondisi Barang Rb</td><td><?php echo $kondisi_barang_rb; ?></td></tr>
	    <tr><td>Nama Peliharaan</td><td><?php echo $nama_peliharaan; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('t_rkpbmdx') ?>" class="btn btn-primary waves-effect waves-themed">Kembali</a></td></tr>
	</table>
</div>
</div>
