...
class M_jenis_barang extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        is_login();
        $this->load->model('M_jenis_barang_model');
    ...
    {
        $this->template->load('template', 'm_jenis_barang/m_jenis_barang_list');
    }

    public function json()
    {
        header('Content-Type: application/json');
        echo $this->M_jenis_barang_model->json();
    }

    public function read($id)
    {
        $row = $this->M_jenis_barang_model->get_by_id($id);
        if ($row) {
            $data = array(
                'id' => $row->id,
            ...
            $this->template->load('template', 'm_jenis_barang/m_jenis_barang_read', $data);
        } else {
            $this->session->set_flashdata('message', '<div class="alert bg-warning-500" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true"><i class="fal fa-times"></i></span>
            </button><strong> Record Not Found</strong></div>');
            redirect(site_url('m_jenis_barang'));
        }
    }
    ...
    public function create()
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('m_jenis_barang/create_action'),
            'id' => set_value('id'),
        ...
        $this->template->load('template', 'm_jenis_barang/m_jenis_barang_form', $data);
    }
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->M_jenis_barang_model->insert($data);
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('m_jenis_barang/update_action'),
    ...
    public function update_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->M_jenis_barang_model->update($this->input->post('id', TRUE), $data);
            $this->session->set_flashdata('message', '<div class="alert bg-info-500" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true"><i class="fal fa-times"></i></span>
    ...
    public function delete($id)
    {
        ...
        if ($row) {
            $this->M_jenis_barang_model->delete($id);
            $this->session->set_flashdata('message', '<div class="alert bg-info-500" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true"><i class="fal fa-times"></i></span>
    ...
    public function excel()
    {
        ...
        $namaFile = "m_jenis_barang.xls";
        $judul = "m_jenis_barang";
        $tablehead = 0;
        $tablebody = 1;
        $nourut = 1;
        //penulisan header
        ...
        xlsWriteLabel($tablehead, $kolomhead++, "Nama Jenis Barang");
        ...
        foreach ($this->M_jenis_barang_model->get_all() as $data) {
            $kolombody = 0;

            //ubah xlsWriteLabel menjadi xlsWriteNumber untuk kolom numeric
            xlsWriteNumber($tablebody, $kolombody++, $nourut);
            xlsWriteLabel($tablebody, $kolombody++, $data->kode_jenis_barang);
            xlsWriteLabel($tablebody, $kolombody++, $data->nama_jenis_barang);
...
/* Location: ./application/controllers/M_jenis_barang.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Codeigniter CRUD Generator 2020-12-22 06:46:19 */
/* http://harviacode.com */
